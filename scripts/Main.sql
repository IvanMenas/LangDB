...
BEGIN
    ...
    ELSE 
        ...
        INSERT INTO HISTORIAL_TRANSACCIONES(ID_TRANSACCION,ID_USER,ID_CUENTA_ORIGEN, id_cuenta_destino ,ID_STATUS,MONTO,DESCRIPCION)VALUES
        (4,P_ID_USER,P_ID_CUENTA_ORIGEN,P_ID_CUENTA_DESTINO,200,P_MONTO,'Transacción');
